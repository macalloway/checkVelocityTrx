<script>
  ...
  <p>To use this service correctly you need to create an account (Free should be enough) to a Solana RPC provider, please vistit this one as i got good results to make this program work : <a href="https://www.quicknode.com/login">quinode RPC provider</a></p>
